...
(function () {
  ...
  var css = ".atlas-btn{position:fixed;right:16px;bottom:16px;z-index:900;font:600 .72rem/1 var(--heading,inherit);letter-spacing:.08em;text-transform:uppercase;color:#e5cc80;background:#0d1626;border:1px solid rgba(229,204,128,.5);border-radius:2px;padding:.6rem .85rem;cursor:pointer}" +
  ...
  var btn = document.createElement("button"); btn.type = "button"; btn.className = "atlas-btn"; btn.textContent = "Map";
  ...
  btn.addEventListener("click", function () { cur.z = null; draw(); ov.hidden = false; document.body.style.overflow = "hidden"; });
